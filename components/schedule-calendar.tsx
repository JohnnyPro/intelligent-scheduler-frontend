...
export const ScheduleCalendar = ({ sessions }: ScheduleCalendarProps) => {
   const days: ScheduledSessionDto['day'][] = ["MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY", "FRIDAY", "SATURDAY", "SUNDAY"];
   const hours = Array.from({ length: TOTAL_HOURS }, (_, i) => i + CALENDAR_START_HOUR);


   const getPositionedSessionsForDay = (daySessions: ScheduledSessionDto[]): PositionedSession[] => {
      ...
      for (const session of sortedSessions) {
         ...
         const baseTop = ((startMinutes - calendarStartMinutes) / totalCalendarMinutes) * 100;
