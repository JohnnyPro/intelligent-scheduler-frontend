...
class AuthRepository {
   ...
   //       return { success: true, accessToken, refreshToken, user: user || null };
   //     } catch (error: any) {
   //       console.error('Register request failed:', error);
   //       return { success: false, accessToken: null, refreshToken: null, user: null, error: error.message || 'Network error' };
   //     }
   //   }
